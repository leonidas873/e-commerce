      ...
      <div className="header__content">
        ...
        <div className="header-col">
          <div className="header__menu">
            ...
            <div className="header__menu-item"><span><Link to="/lookbook">Lookbook</Link></span></div>
          </div>
        </div>
        <div className="header-col">
        ...
        <AiOutlineClose className="search__close-icon" onClick={handleCloseSearch}/>
        </div>
      </Offcanvas>
      </div>
      
<BurgerMenu showBurgerMenu={showBurgerMenu} setShowBurgerMenu={()=>setShowBurgerMenu(false)} categories={{bags:bags, shoes:shoes}}/>
